...
describe('learn_about', () => {
  ...
  describe('Basic Functionality', () => {
    ...
    it('learned belief can use traits from archetype chain', () => {
      ...
      const hammer = DB.get_first_belief_by_label('hammer');
  ...
  describe('Edge Cases', () => {
    ...
    it('learned belief can be used as trait reference', () => {
      ...
      const workshop_knowledge = player_mind_state.learn_about(
        DB.get_first_belief_by_label('workshop'),
        [],
        world_state
      );
      ...
      const hammer_knowledge = player_mind_state.add_belief({
        ...
        bases: ['PortableObject'],
        traits: { location: workshop_knowledge.subject }
      });
    ...
    it('learn_about directly from base belief works', () => {
      ...
      const base_hammer = DB.get_first_belief_by_label('base_hammer');
    ...
    it('learn_about should dereference trait beliefs to learning mind', () => {
      const world_state = createMindWithBeliefs('world', {
        ...
        hammer: {
          bases: ['PortableObject'],
          traits: { location: 'workshop' }  // References DB.get_first_belief_by_label('workshop')
        }
      });
      ...
      const hammer_knowledge = npc_mind_state.learn_about(
        DB.get_first_belief_by_label('hammer'),
        ['location'],
        world_state
      );
      ...
      expect(location_ref.get_about(npc_mind_state)).to.equal(DB.get_first_belief_by_label('workshop'));
    ...
    it('learn_about should reuse existing beliefs with same about reference', () => {
      ...
      const existing_workshop = npc_mind_state.add_belief({
        ...
        bases: ['Location'],
        traits: {
          '@about': DB.get_first_belief_by_label('workshop').subject
        }
      });
    ...
    it('learn_about should update first belief when multiple beliefs about same entity exist', () => {
      ...
      const belief1 = npc_mind_state.add_belief({
        ...
        bases: ['Location'],
        traits: {
          '@about': DB.get_first_belief_by_label('workshop')
        }
      });
    ...
    it('learn_about is not transitive - about points to the belief, not what it\'s about', () => {
      ...
      expect(workshop_from_npc2.get_about(npc2_mind_state)).to.not.equal(DB.get_first_belief_by_label('workshop'));
    });
    ...
    it('learn_about should dereference arrays of beliefs', () => {
      ...
      const chest = world_mind_state.add_belief({
        ...
        bases: ['Container'],
        traits: {
          items: [sword.subject, shield.subject]
        }
      });
    ...
    it('learn_about copies trait values even when inherited from base', () => {
      ...
      const hammer_v1 = world_state.add_belief({
        label: 'hammer',
        bases: ['PortableObject'],
        traits: {
