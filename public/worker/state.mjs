 ...
 * @param {typeof import('./serialize.mjs').Serialize} refs.Serialize
 */
export function init_state_refs(refs) {
  Belief = refs.Belief
  Mind = refs.Mind
  Serialize = refs.Serialize
}
...
export class State {
  ...
  *get_beliefs() {
  ...
  toJSON() {
    ...
    if (Serialize && Serialize.dependency_queue !== null && this.in_mind) {
