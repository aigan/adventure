/**
 * Inspection - Development Tools Communication
 *
 * BroadcastChannel for inspection UI (dev tools).
 * Handles queries about minds, states, beliefs, archetypes, etc.
 */
...
export async function init_channel(session_param) {
	...
	// Wire up session to broadcast channel for state change notifications
	session.set_broadcast_channel(channel)
